...
;~ DEMOS
	  ...
	  Call(FileSort, "Tech Demo", $DemoFolder & "\Tech Demos", $Files[$f])
;~ VIDEOS
	  Call(FileSort, "Game Boy Advance Video", $VideoFolder, $Files[$f])
;~ PROGRAMS
	  Call(FileSort, "Program)", $ProgramFolder, $Files[$f])
	  Call(FileSort, "Demonstration Program", $ProgramFolder, $Files[$f])
	  Call(FileSort, "Game Genie", $ProgramFolder, $Files[$f])
	  Call(FileSort, "CodeBreaker", $ProgramFolder, $Files[$f])
	  Call(FileSort, "GameShark", $ProgramFolder, $Files[$f])
	  Call(FileSort, "Action Replay", $ProgramFolder, $Files[$f])
	  Call(FileSort, "X-Terminator", $ProgramFolder, $Files[$f])
	  Call(FileSort, "Xploder", $ProgramFolder, $Files[$f])
	  Call(FileSort, "Game Saver", $ProgramFolder, $Files[$f])
	  Call(FileSort, "Tri-Star", $ProgramFolder, $Files[$f])
	  Call(FileSort, "Super 8", $ProgramFolder, $Files[$f])
	  Call(FileSort, "Super Game Boy", $ProgramFolder, $Files[$f])
	  Call(FileSort, "Advanced Music Player", $ProgramFolder, $Files[$f])
	  Call(FileSort, "GBA Movie Player", $ProgramFolder, $Files[$f])
	  Call(FileSort, "GBA Personal Organizer ", $ProgramFolder, $Files[$f])
	  Call(FileSort, "GBA AV Adapter", $ProgramFolder, $Files[$f])
	  Call(FileSort, "GB-A TV Tuner", $ProgramFolder, $Files[$f])
	  Call(FileSort, "GameBooster 64", $ProgramFolder, $Files[$f])
	  Call(FileSort, "Xplorer 64", $ProgramFolder, $Files[$f])
;~ COLLECTIONS
	  If $Mode = "0" Then
		 ...
		 Call(FileSort, "(Cowabunga Collection", $CollectionFolder & "\The Cowabunga Collection", $Files[$f])
		 ...
		 Call(FileSort, "(Bomberman Collection", $CollectionFolder & "\Bomberman Collection", $Files[$f])
		 Call(FileSort, "Mega Drive Mini 2", $CollectionFolder & "\Mega Drive Mini 2", $Files[$f])
		 Call(FileSort, "Genesis Mini 2", $CollectionFolder & "\Mega Drive Mini 2", $Files[$f])
		 Call(FileSort, "Mega Drive Mini", $CollectionFolder & "\Mega Drive Mini", $Files[$f])
		 Call(FileSort, "Genesis Mini", $CollectionFolder & "\Mega Drive Mini", $Files[$f])
		 Call(FileSort, "3DS Virtual Console", $CollectionFolder & "\3DS Virtual Console", $Files[$f])
		 Call(FileSort, "Wii Virtual Console", $CollectionFolder & "\Wii Virtual Console", $Files[$f])
		 Call(FileSort, "Wii U Virtual Console", $CollectionFolder & "\Wii UVirtual Console", $Files[$f])
		 ...
		 Call(FileSort, "Nintendo Switch", $CollectionFolder & "\Nintendo Switch", $Files[$f])
		 ...
		 Call(FileSort, "(Metal Gear Solid Collection)", $CollectionFolder & "\Metal Gear Solid Collection", $Files[$f])
		 ...
		 Call(FileSort, "(Sega 3D Classics Collection)", $CollectionFolder & "\Sega 3D Classics Collection", $Files[$f])
		 Call(FileSort, "Switch)", $CollectionFolder & "\Switch", $Files[$f])
		 Call(FileSort, "(Competition Cart", $CollectionFolder & "\Competition Cart", $Files[$f])
		 Call(FileSort, "(Arcade)", $CollectionFolder & "\Arcade", $Files[$f])
		 Call(FileSort, "(QUByte Classics)", $CollectionFolder & "\QUByte Classics", $Files[$f])
		 Call(FileSort, "(Retro Collection)", $CollectionFolder & "\Retro Collection", $Files[$f])
		 Call(FileSort, "(Game no Kanzume", $CollectionFolder & "\Game no Kanzume", $Files[$f])
		 Call(FileSort, "(Sega Ages)", $CollectionFolder & "\Sega Ages", $Files[$f])
		 Call(FileSort, "(Sega Smash Pack)", $CollectionFolder & "\Sega Smash Pack", $Files[$f])
		 Call(FileSort, "(Sega Smash Pack 2)", $CollectionFolder & "\Sega Smash Pack 2", $Files[$f])
		 Call(FileSort, "(Sega Gopher)", $CollectionFolder & "\Sega Gopher", $Files[$f])
		 Call(FileSort, "(SegaNet)", $CollectionFolder & "\SegaNet", $Files[$f])
		 Call(FileSort, "Arcade Legends", $CollectionFolder & "\Arcade Legends", $Files[$f])
